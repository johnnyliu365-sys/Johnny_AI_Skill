...
| 功能集群 | 規格 | 狀態 |
| --- | --- | --- |
| Receipt-bound role supervision | [`receipt-bound-role-supervision.md`](receipt-bound-role-supervision.md) | `DRAFT / OWNER_APPROVAL_REQUIRED`；不得建立 ticket、dispatch 或 heartbeat。 |
