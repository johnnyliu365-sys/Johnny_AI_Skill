...
R02C1, R02C2 and R02C2A are complete. R02C3 is the only dependency-satisfied ticket-design
candidate. Later candidates remain blocked until their serial predecessor is independently
