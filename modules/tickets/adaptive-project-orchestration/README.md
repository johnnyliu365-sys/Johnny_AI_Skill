...
| [02c3-bounded-library-selection](02c3-bounded-library-selection.md) | One selected archive/reusable-library partition path resolves to one exact eligible leaf without discovery or sibling loading. | `IN_PROGRESS / RECEIPT_BOUND` | `PRG-20260815-498` / `rcpt-adaptive-router-r02c3-20260815` |
