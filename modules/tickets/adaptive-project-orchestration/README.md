...
| --- | --- | --- | --- |
| [01-route-instruction-contract](01-route-instruction-contract.md) | Every Router decision carries one versioned skill reference and one exact expected typed return; technical halts use the Profile's router-control fallback. | `CHANGES_REQUESTED / REVISION_02_REFROZEN` | CR-R01-001..003; same receipt, owner, branch and exact five-file scope |
