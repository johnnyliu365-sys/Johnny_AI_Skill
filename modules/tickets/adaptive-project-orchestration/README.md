...
| [02b-agent-context-lease-invalidation-gate](02b-agent-context-lease-invalidation-gate.md) | One implementation-owner, ticket-bound Agent Context lease; correction invalidates and ticket switch closes the old view before a fresh identity exists. | `IN_PROGRESS / DISPATCH_CONFIRMED` | `PRG-20260815-471` |
...
R02B is the only active implementation ticket. Later files are created from the independently accepted
