...
| [02c3-bounded-library-selection](02c3-bounded-library-selection.md) | One selected archive/reusable-library partition path resolves to one exact eligible leaf without discovery or sibling loading. | `CHANGES_REQUESTED / RECEIPT_BOUND` | `CR-R02C3-001` / `rcpt-adaptive-router-r02c3-20260815` |
