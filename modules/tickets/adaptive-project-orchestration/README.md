...
| `02C2-requirement-retirement-archive-lineage` | One-to-one active PRD/CHG pairing, retirement and archive-only reachability. | `CANDIDATE / READY_FOR_TICKET_FREEZE` | R02C1 `5b887c72` |
...
R02C1 is complete. R02C2 is the only dependency-satisfied design closure and remains
non-dispatchable until its exact ticket and receipt are frozen. R02C3 and later candidates remain
dependency-blocked. Candidate labels are not implementation authority.
