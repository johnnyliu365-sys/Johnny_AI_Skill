...
| [09b-managed-artifact-transaction](09b-managed-artifact-transaction.md) | One managed-plan transaction writes every bound document atomically, restores exact prior bytes on any failure, and proves the candidate post-state before success. | `OPEN / APPROVED / DISPATCH_READY` | R09A integrated at `91da8135e301992635d716c6cefa068ad950d807`; owner authority 2026-08-28 |
...
authorize the legacy Router R04 candidate. R09A is closed. R09B is its approved, serial
transaction successor; R09C–R09E and publication remain unopened.
