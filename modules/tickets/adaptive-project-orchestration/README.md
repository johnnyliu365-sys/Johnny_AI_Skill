...
| [02c1-artifact-tree-resolution-gate](02c1-artifact-tree-resolution-gate.md) | Generic bounded topology and exact one-path resolution for every declared workflow artifact family. | `IN_PROGRESS / RECEIPT_BOUND` | `6897bcc` / `PRG-20260815-480` |
...
R02C1 is the only active implementation ticket. R02C2 and all later candidates remain
non-dispatchable until R02C1 is independently approved and integrated.
