...
| State / closure | `BLOCKED / EVIDENCE_ORDERING_DEVIATION / INTEGRATED_ALREADY / OWNER_DECISION_REQUIRED`; `CLOSURE-ADAPTIVE-R09B1-RECOVERABLE-MANAGED-ARTIFACT-CONTRACTS-01` |
