...
| Dispatch binding | `SIDE-CONTEXT-ADAPTIVE-CAP-REMOTE-AUTHORITY-01-20260829-01`; branch `implement/cap-remote-authority-01`; repository-contained worktree `.worktrees/cap-remote-authority-01-implementation`; baseline `20b8adaa5ae24b121b7dee19eb928ee65925904e`. This is one same-lifetime reviewer allocation: no runner, queue, receipt, descriptor, gateway or host-workspace readback is created or required. |
