...
| [08-isolated-publication-live-cutover.md](08-isolated-publication-live-cutover.md) | `BLOCKED / TICKET_DEFECT / UPSTREAM_CLOSURE_CONTRACT` | A real isolated Claude install from README reaches only the publication object graph. | `C = 758a718` fails Ticket 06 L2 because its self-pin carrier is intentionally neutralized by the generator but not by the closure verifier. No source/publication ref was pushed; corrective closure-contract ticket required. |
