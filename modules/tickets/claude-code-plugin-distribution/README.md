...
| [08-isolated-publication-live-cutover.md](08-isolated-publication-live-cutover.md) | `APPROVED / DISPATCH_AUTHORIZED / OWNER_EFFECT_AUTHORITY_RECORDED` — baseline `2f45831` | A real isolated Claude install from README reaches only the publication object graph. | Owner authority records the named repository, CAS/tag, temporary raw ref, integration/push and isolated CLI effects; source approval remains required before any effect. |
