...
| [08-isolated-publication-live-cutover.md](08-isolated-publication-live-cutover.md) | `CONVERGENCE_REVIEW_REQUIRED / OWNER_EFFECT_AUTHORITY_RECORDED / REVISION_07` | A real isolated Claude install from README reaches only the publication object graph. | CLOSURE_04 remains bound. L5's post-generation stale-pin test must use an explicit disposable stale-pin mutation; a correct live generated descriptor is green, not stale. No publication or Claude effect is authorized until a fresh Terra review closes this lifecycle correction. |
