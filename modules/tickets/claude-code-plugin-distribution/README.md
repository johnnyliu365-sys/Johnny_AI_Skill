...
| [08-isolated-publication-live-cutover.md](08-isolated-publication-live-cutover.md) | `CONVERGENCE_REVIEW_REQUIRED / OWNER_EFFECT_AUTHORITY_RECORDED / REVISION_06` | A real isolated Claude install from README reaches only the publication object graph. | The owner authority remains bound, but L3 requires a new source-level exclusivity test: a suspended historical raw route added beside valid text must turn red before reviewer generation or any effect. |
