...
| [08-isolated-publication-live-cutover.md](08-isolated-publication-live-cutover.md) | `OPEN / OWNER_EFFECT_AUTHORITY_RECORDED / CLOSURE_03` | A real isolated Claude install from README reaches only the publication object graph. | F3 integrated at `7a64f63`; owner selected `0.4.11` and authorized one exact candidate/baseline/correlation. Terra must still bind fresh remote readback and complete L1–L6 before every external effect. |
