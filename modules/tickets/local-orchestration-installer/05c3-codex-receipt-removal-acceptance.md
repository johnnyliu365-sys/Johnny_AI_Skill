...
- One fresh success transaction produces the actual integrated receipt. The
  exact receipt is then consumed by 05C1/05C2 through an admitted oracle port.
...
This child will be refrozen against the exact integrated 05C2 API before lane
