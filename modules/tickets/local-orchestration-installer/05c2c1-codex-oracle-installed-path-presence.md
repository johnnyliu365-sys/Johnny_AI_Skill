...
| Revision | `01` |
| State | `PLANNED / FROZEN / NO_IMPLEMENTATION_AUTHORITY` |
...
No implementation authority exists until the reviewer commits an exact lane
registry against this freeze.
