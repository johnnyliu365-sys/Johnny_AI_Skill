...
## Correction owner restoration — CR-162 / CR-163 / CR-164

| Field | Value |
| --- | --- |
| Replacement-lane HALT | On the resumed turn, task `019ff01a-3afc-79e3-aa7e-a467b8da9b9d` passed read-only admission but its sandbox could not create the linked-worktree `index.lock`. Branch creation failed before mutation; `workflow-implementer-2` remains clean at `b153636fe2acd37af0b376ee825e0cf9336b98b1` and the proposed correction branch remains absent. |
| Restored owner / lane | Capacity is available again for original task `019fcc9c-f34f-7d53-a313-c70c90bf3245`. Restore that implementation owner in existing `workflow-implementation`, exact clean branch `codex/implementation-codex-registration-oracle-adapter-05b4b2e2` at immutable handoff `699cba8f1b844552a9b36baf926613594542ed4b`. Corrections are additive on the same branch; no new branch or worktree is required. |
| Binding | Restored correction handoff `hnd_local_orchestration_install_05b4b2e2_cr162_164_restore_20260813`; allocation `aln_local_orchestration_install_05b4b2e2_cr162_164_restore_20260813`; retained valid receipt `rcpt_local_orchestration_install_05b4b2e2_r02_20260813`; correlation `corr-local-orchestration-install-05b4b2e2-cr162-164-restore-20260813`; question `q-local-orchestration-install-05b4b2e2-cr162-164-restore-20260813`; side-context `scx-local-orchestration-install-05b4b2e2-cr162-164-restore-20260813-01`. |
| Scope / assistant policy | Same two source/test paths plus one unique WPR-only handoff. This correction is bounded and low-search, so no Luna helper is allocated. The reviewer remains the sole Agent orchestrator. |

## Product task／workspace rebind — CR-162 / CR-163 / CR-164

| Field | Value |
| --- | --- |
| Rebind trigger | Product readback proved both historical implementation tasks were still rooted at the control project; prompt／handoff paths and command working directories were not workspace bindings. Those tasks and commits remain immutable evidence and are no longer dispatch targets. |
| Owner override / active project | `ovr_local_orchestration_install_05b4b2e2_task_rebind_20260813`; Local project `6d2ebb66-1ae7-48b4-96da-53ffba88ef1f`; replacement task `019ffb0c-c9c7-7b30-b614-02dea7ed9042`. |
| Workspace binding | `wsb_local_orchestration_install_05b4b2e2_cr162_164_20260813_01`; `wtr_workflow_implementation_20260813_01`. Product cwd, canonical Git top-level and linked-worktree git-dir independently resolve to the existing permanent `workflow-implementation` worktree. Branch `codex/implementation-codex-registration-oracle-adapter-05b4b2e2` is clean at `d3569f24d6686ae5bf9efe43d47bf6cd5ec82851`. |
| Rebound authority | Handoff `hnd_local_orchestration_install_05b4b2e2_cr162_164_rebind_20260813`; allocation `aln_local_orchestration_install_05b4b2e2_cr162_164_rebind_20260813`; retained valid unconsumed receipt `rcpt_local_orchestration_install_05b4b2e2_r02_20260813`; correlation `corr-local-orchestration-install-05b4b2e2-cr162-164-rebind-20260813`; question `q-local-orchestration-install-05b4b2e2-cr162-164-rebind-20260813`; side-context `scx-local-orchestration-install-05b4b2e2-cr162-164-rebind-20260813-01`. |
