...
| State | `IN_PROGRESS` — fresh allocation `aln_local_orchestration_install_01_rework_5_20260809` addresses CR-40/46 and reopened CR-38/42/43; receipt `rcpt_local_orchestration_install_01_20260808` continues without a second question |
...
- Blocked histories: `010110a` / `7bc5fd5`; `fd429fd`, `a222d89` / `8e39c99`; `4b840cd` / `7c73b14`; `c91041a` / `ba74caf`; `7df74e1`, `e84dff0`, `14838d9` / `f90877d`. None may be reset, overwritten, cherry-picked or reused.
