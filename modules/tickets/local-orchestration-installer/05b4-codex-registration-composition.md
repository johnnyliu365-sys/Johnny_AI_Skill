...
| State | `CONVERGENCE_DECOMPOSED / CHILD_05B4B1_CONVERGENCE_REVIEW_REQUIRED / CHILD_05B4B2_DEPENDENCY_WAIT` |
...
current-generation or consumption authority. Control-plane refreeze is required;
05B4B2 remains dependency-waiting and undispatched.
