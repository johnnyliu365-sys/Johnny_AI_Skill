...
| [05B4B2](05b4b2-codex-registration-transaction-coordinator.md) | Decompose transaction authority, forward effects, settlement and disposable lifecycle acceptance. | 05B4B1 revision 02 approved and integrated |
| [05B4B2A](05b4b2a-codex-registration-transaction-authority.md) | Own effect-free process-local generation and one-shot phase admission. | 05B4B1 revision 02 approved and integrated |
...
for B2. B2 is now decomposed; only B2A is frozen and dispatch-pending, while
B2B-B2E remain dependency-waiting and unallocated.
