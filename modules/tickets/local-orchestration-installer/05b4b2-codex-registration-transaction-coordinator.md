...
| [05B4B2B2](05b4b2b2-codex-registration-compensation-context.md) | Bind the complete exact registration request into terminal compensation data before any removal composition can be authorized. | B2B1 integrated; may run in parallel with B2C |
