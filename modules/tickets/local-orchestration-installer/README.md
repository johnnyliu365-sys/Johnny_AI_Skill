...
| [05b-codex-cli-transactional-registration](05b-codex-cli-transactional-registration.md) | One exact registration returns a proof-bound receipt or performs verified current-attempt compensation and blocks. | `BLOCKED / TICKET_DEFECT` — implementation `5e919069`, handoff `ef1cf42`, initial review CR-92..CR-97; no correction dispatched | Ticket 05A integrated by `b22c6c4` |
