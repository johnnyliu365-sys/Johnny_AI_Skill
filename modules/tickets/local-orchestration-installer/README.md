...
| [05s2-bounded-child-process-runner](05s2-bounded-child-process-runner.md) | Run one deterministic generic child with explicit argv/environment and finite timeout. | `IN_PROGRESS / REVISION_03_REFROZEN / ONE_CORRECTION_AUTHORIZED` — CR-124 only; same branch/worktree | 05S1 integrated by `504a3ec` |
