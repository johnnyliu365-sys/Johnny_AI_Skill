...
| [05b3-codex-exhaustive-compensation](05b3-codex-exhaustive-compensation.md) | Remove current-attempt plugin then marketplace, run all fresh absence probes and retain only unresolved authority. | `PLANNED / READY_FOR_DISPATCH` | 05B2 integrated by `c97505c` / `ef45f65` |
