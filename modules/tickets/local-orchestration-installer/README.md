...
- Parent Ticket 05's rejected branch and Ticket 05A's integrated branch remain read-only evidence; their allocations are released. Ticket 05B revision 02 is paused after terminal correction review. Its branch, worktree, allocation and receipt remain inactive evidence and grant no new implementation authority. Tickets 05C and 04 remain dependency-waiting. The implementation owner must not modify this control-plane worktree; the reviewer must not modify the implementation worktree.
