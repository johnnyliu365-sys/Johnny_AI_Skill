...
| [05b1-codex-registration-contracts-and-journal](05b1-codex-registration-contracts-and-journal.md) | Strictly bind observed add fields to proof/receipt and model finite current-attempt authority without effects. | `CHANGES_REQUESTED / TICKET_REFREEZE_REQUIRED` — implementation `fbedefc`, handoff `6969d44`; CR-128..CR-132 batched | 05A and 05S1-05S4 integrated |
