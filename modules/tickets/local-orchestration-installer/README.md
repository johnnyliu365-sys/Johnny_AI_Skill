...
| [05b3a-codex-safe-port-capability](05b3a-codex-safe-port-capability.md) | Admit one closed five-operation port capability with zero dynamic descriptor reads or operation calls. | `IN_PROGRESS / IMPLEMENTATION_DISPATCH_CONFIRMED` | 05B1/05B2 integrated; ADR-20260811-004 |
| [05b3b-codex-compensation-reducer](05b3b-codex-compensation-reducer.md) | Purely plan exact compensation and reduce complete normalized evidence to residual authority. | `IN_PROGRESS / IMPLEMENTATION_DISPATCH_CONFIRMED` | 05B1/05B2 integrated; independent of 05B3A source |
| [05b3c-codex-compensation-composition](05b3c-codex-compensation-composition.md) | Execute only a validated capability in reducer order and map exact observations. | `PLANNED / DEPENDENCY_WAIT` | 05B3A and 05B3B integrated |
| 05B4 registration composition | Compose fresh admission, proof, journal, compensation and 05S4 oracle into one finite registration result. | `PLANNED / DEPENDENCY_WAIT` | 05B3C integrated |
...
- Named implementation capabilities: task `019fcc9c-f34f-7d53-a313-c70c90bf3245` owns only `workflow-implementation` and is proposed for 05B3A; task `019ff01a-3afc-79e3-aa7e-a467b8da9b9d` owns only `workflow-implementer-2` and is proposed for 05B3B. Each owner works alone and may not control or read uncommitted state from the other lane.
- Parent Ticket 05, combined Ticket 05S, old 05B and rejected 05B3 remain immutable evidence. 05S1-05S4 and 05B1-05B2 are integrated. 05B3A and 05B3B are disjoint parallel children; 05B3C, 05B4, 05C and package Ticket 04 remain dependency-waiting. Implementation owners must not modify the control worktree or one another's worktree; the reviewer must not modify either implementation worktree.
