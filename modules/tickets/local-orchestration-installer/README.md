...
| [06a-codex-role-profile-capability-proof](06a-codex-role-profile-capability-proof.md) | Prove in a disposable Codex home that reviewer tools are present and implementation multi-agent tools are disabled; otherwise return a typed host block. | `APPROVED / INSTALL_BLOCKED / ROLE_ISOLATION_UNPROVEN / INTEGRATION_AUTHORIZED` — evidence implementation `38e9a8b`, handoff `f6f186f`; actual host `ACCESS_DENIED / OUTPUT_UNAVAILABLE` | 05S1-05S4 integrated; downstream role-profile path stopped |
