...
| [05b3a-codex-safe-port-capability](05b3a-codex-safe-port-capability.md) | Admit one closed five-operation port capability with zero dynamic descriptor reads or operation calls. | `PLANNED / READY_FOR_DISPATCH` | 05B1/05B2 integrated; ADR-20260811-004 |
| [05b3b-codex-compensation-reducer](05b3b-codex-compensation-reducer.md) | Purely plan exact compensation and reduce complete normalized evidence to residual authority. | `PLANNED / READY_FOR_DISPATCH` | 05B1/05B2 integrated; independent of 05B3A source |
