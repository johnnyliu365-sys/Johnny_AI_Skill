...
| [05s3-codex-protocol-fixture](05s3-codex-protocol-fixture.md) | Validate documented Codex add/list/remove JSON shapes without lifecycle state. | `CHANGES_REQUESTED / FINAL_REVIEW_STOPPED` — CR-125; no automatic correction | 05S2 integrated by `6e24e06` |
...
- Parent Ticket 05 and combined Ticket 05S remain immutable rejected evidence; 05S1/05S2 are integrated and 05B stays paused. 05S3 stopped at CR-125 with no active implementation allocation; 05S4/05C/04 remain dependency-waiting. The implementation owner must not modify this control-plane worktree; the reviewer must not modify the implementation worktree.
