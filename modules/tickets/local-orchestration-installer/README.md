...
| [05-codex-cli-host-adapter](05-codex-cli-host-adapter.md) | One exact installer-owned Codex marketplace/plugin registration is receipt-bound, verified and completely removed without touching another plugin or target project. | `IN_PROGRESS / DISPATCH_PREPARED` - finite K1–K8 closure and unique handoff/allocation/receipt | Tickets 01–03 integrated; owner-authorized live CLI capability proof complete |
