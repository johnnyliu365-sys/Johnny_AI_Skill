...
| [05s4-codex-lifecycle-oracle](05s4-codex-lifecycle-oracle.md) | Persist exact owned/foreign lifecycle and payload truth without adapter transaction logic. | `PLANNED / READY / NOT_DISPATCHED` | 05S3 integrated by `43a1639` |
