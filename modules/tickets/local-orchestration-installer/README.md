...
| [05s3-codex-protocol-fixture](05s3-codex-protocol-fixture.md) | Validate documented Codex add/list/remove JSON shapes without lifecycle state. | `PLANNED / READY / NOT_DISPATCHED` | 05S2 integrated by `6e24e06` |
