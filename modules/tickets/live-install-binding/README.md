...
| L11 | [One-click console-stream observability](l11-one-click-console-stream-observability.md) | Windows refusal tests observe the complete decoded console stream instead of treating stdout as the entire user-visible transcript. | `READY / NOT_DISPATCHED / REVISION_01` — fixes the verified false regression without changing the wrapper or installer. |
