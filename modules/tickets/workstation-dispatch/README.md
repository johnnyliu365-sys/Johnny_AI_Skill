...
| P8R-R04 | [Canonical provider-neutral executor routing](p8r-provider-neutral-executor-routing-r04.md) | `APPROVED / REVIEW_CORRECTION / REVISION_05` — POC/standard canonical resolver; reviewer-only generated publication pin added after full-regression ticket-defect finding |
