...
| P8R-R04 | [Canonical provider-neutral executor routing](p8r-provider-neutral-executor-routing-r04.md) | `APPROVED / NOT_DISPATCHED` — POC/standard canonical resolver; Luna/xhigh implementation, Terra/xhigh review, named host-readback gap |
