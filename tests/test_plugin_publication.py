...
_RELEASE_VERSION: Final[str] = "0.4.10"
...
_RAW_MARKETPLACE_URL: Final[str] = (
...
class CandidateMetadataTests(unittest.TestCase):
    """Local L1/L3/L5 checks for the candidate before reviewer publication effects."""
    ...
    def test_l3_readme_uses_raw_descriptor_and_complete_user_commands(self) -> None:
        ...
        self.assertIn(f"claude plugin marketplace add {_RAW_MARKETPLACE_URL}", readme)
        self.assertNotIn("claude plugin marketplace add johnnyliu365-sys/Johnny_AI_Skill", readme)
        self.assertIn("claude plugin install johnny-ai-skill@johnny-ai-skill --scope user", readme)
        self.assertIn("claude plugin update johnny-ai-skill@johnny-ai-skill --scope user", readme)
        self.assertIn("claude plugin uninstall johnny-ai-skill@johnny-ai-skill --scope user", readme)
