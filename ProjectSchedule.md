...
| Ticket 05A CLI contract/preflight | BLOCKED / SUPERSEDE_REQUIRED | Final code closes A1–A4, but terminal A5 review found implementation-turn hidden cache writes and a duplicate canonical progress-record ID. No further correction or dispatch. |
