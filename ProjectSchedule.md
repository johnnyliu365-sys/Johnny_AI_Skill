...
| Ticket 05B4 registration composition parent | CONVERGENCE_DECOMPOSED / CHILD_05B4B1_REVISION_02_DISPATCH_PENDING / CHILD_05B4B2_DEPENDENCY_WAIT | CR-148 refreeze keeps B1 stateless and assigns generation/one-shot replay authority to B2. |
...
| Ticket 05B4B1 pure registration reducer | IN_PROGRESS / REVISION_02_FREEZE / DISPATCH_PENDING | Remove Python object-identity authority; copied/rebuilt exact values remain pure data and effect replay stays out of B1. |
