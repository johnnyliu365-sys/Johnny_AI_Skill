...
| Ticket 05A CLI contract/preflight | BLOCKED / OWNER-AUTHORIZED EVIDENCE REPAIR PENDING | A1–A4 remain closed. Owner authorized one same-worktree cache-cleanup and docs-only CR-90/CR-91 repair; no source change, new branch/worktree or dependent-ticket start. |
