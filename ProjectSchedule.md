...
| Ticket 05B4B2E0 oracle logical installed path | CHANGES_REQUESTED / SAME_CLOSURE_CORRECTION_PENDING | CR-157 exact logical-path identity and CR-158 Win32 segment-normalization correction; retain existing implementation branch/worktree. |
