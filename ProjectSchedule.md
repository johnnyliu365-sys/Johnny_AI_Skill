...
| Ticket 05B2 command-attempt classification | PLANNED / NEXT_UNBLOCKED | Finite pre-command denial versus ambiguous attempted-effect classification now follows integrated 05B1. |
