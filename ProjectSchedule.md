...
| Ticket 05B1 registration contracts/journal | IN_PROGRESS / REVISION_02_DISPATCH_CONFIRMED | One same-branch additive correction refreezes CR-128..CR-132: separate expected auth policy, typed proof-port failure semantics, exact seven-state journal matrix and truthful committed TDD. |
