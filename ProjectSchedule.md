...
| Ticket 05C2C2 adapter installed-path truth | CHANGES_REQUESTED / SOURCE_ONLY_CORRECTION | M1-M7 pass; CR-178 fixes false method documentation and return indentation only. |
