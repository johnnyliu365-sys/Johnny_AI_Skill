...
| Ticket 05B2 command-attempt classification | PLANNED / READY_FOR_DISPATCH | Pure classifier closure freezes pre-start zero-authority, started `MAY_EXIST`, exact confirmation and all 14 command/journal admission cells. |
