...
| Ticket 05B4 registration composition parent | CONVERGENCE_DECOMPOSED / CHILD_05B4B1_CR149_CORRECTION_DISPATCHED / CHILD_05B4B2_DEPENDENCY_WAIT | CR-148 is closed; bounded CR-149 B1 validation correction is active before B2. |
...
| Ticket 05B4B1 pure registration reducer | IN_PROGRESS / REVISION_02_CR149_CORRECTION_DISPATCHED | Same-lane correction must make all three missing-`status` cells return finite `INVALID_STATE`. |
