...
| Ticket 05B4B2E2A oracle version observation | PLANNED / REVIEWED_FREEZE / DISPATCH_PENDING | Supplies caller-independent fresh CLI-version evidence before E2. |
| Ticket 05B4B2E3A compensation finite failure | PLANNED / REVIEWED_FREEZE / DISPATCH_PENDING | Supplies a request-bound finite effect-failure value before E3. |
