...
| Ticket 05S1R project-owned disposable runtime root | CONVERGENCE_REVIEW_REQUIRED / CHILD_DECOMPOSITION_REQUIRED | Revision-02 closes CR-167/168, but checkout-under-TEMP independently fails because T1 retains the broad TEMP assertion and no pre-assertion lease cleanup. Third same-ticket correction is prohibited; CR-169 requires one finite child. |
