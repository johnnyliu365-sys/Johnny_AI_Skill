...
| Ticket 05B4 registration composition parent | CONVERGENCE_DECOMPOSED / CHILD_05B4B1_FROZEN / CHILD_05B4B2_DEPENDENCY_WAIT | Safe port admission, exact identity, pure forward reduction and effect composition are serial children; no requirement change. |
...
| Ticket 05B4B1 pure registration reducer | IN_PROGRESS / FROZEN / DISPATCH_PENDING | Exact D1-D8; no port call, CLI effect, receipt or final success. |
