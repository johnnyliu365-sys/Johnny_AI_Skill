...
| Ticket 05B4B2E3 compensation oracle adapter | FROZEN / READY_FOR_DISPATCH / NOT_DISPATCHED | Closure A1-A8; one thin adapter plus one focused test, assigned only after exact lane readback. |
