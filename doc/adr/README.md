...
| [ADR-20260817-018-host-bound-bootstrap-no-effect-recovery.md](ADR-20260817-018-host-bound-bootstrap-no-effect-recovery.md) | `ACCEPTED` | 綁定 target task host、在 claim 前解析 host manager，並允許已證明未進入 adapter 的同一 operation 一次性延續。 |
