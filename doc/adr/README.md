...
| [ADR-20260816-016-self-host-bootstrap-dispatch-exception.md](ADR-20260816-016-self-host-bootstrap-dispatch-exception.md) | `ACCEPTED` | 以本專案限定的 grant／attempt／relay／integration 路徑解除 live receipt 自我託管循環，R03-03 真實證明後永久關閉。 |
| [ADR-20260816-017-r03-durable-metadata-recovery.md](ADR-20260816-017-r03-durable-metadata-recovery.md) | `PROPOSED / OWNER_APPROVAL_PENDING` | 將失敗 R03-01 重切為 contracts／durable transaction／registry／receipt CAS，並隔離 reviewer 的寫入型驗證環境。 |
