...
| [ADR-20260815-012-receipt-bound-event-driven-completion-supervision.md](ADR-20260815-012-receipt-bound-event-driven-completion-supervision.md) | `PROPOSED / OWNER_APPROVAL_REQUIRED` | 以 Git ref 事件、receipt-bound handoff、一次性 role wake 與模型分級期限監督實作；永不隱含 heartbeat，且插件可無條件拔除。 |
