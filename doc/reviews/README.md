...
功能集群的正式審閱報告存放於此；每份報告記錄其基準、受審 commits、命令與結論。

| Feature cluster | Report | Result |
| --- | --- | --- |
| Controlled verification | [Cluster review index](controlled-verification/README.md); `INDEX-CONTROLLED-VERIFICATION-REVIEWS` / `REVIEW_INDEX` / revision `32`, LF `a704d281d56f03ec65641f37aef53ab359a521b8a3013e20fe47a1c475e39254` | `ACTIVE / CVQ01A1_A2_A3_REVIEW_APPROVED / CVQ01B_BINDING_READY / CVE01A_APPROVED_NOT_INTEGRATED` |
...
| Plugin adoption quality | [Cluster review index](plugin-adoption-quality/README.md) | `WA-01_APPROVED / AUTHORITY_INTEGRATED; UIX-01_APPROVED / AUTHORITY_INTEGRATED; UIX-02_APPROVED / LOCAL_INTEGRATED / REMOTE_SYNC_PENDING; REQ-052_LOCAL_INSTALL_VERIFIED / LOCAL_FIXTURE_15_PASS / PUBLICATION_INCOMPLETE / PIN_STALE_CONFIRMED / EXECUTABLE_GATES_PENDING` |
