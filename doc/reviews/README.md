...
| --- | --- | --- |
| Controlled verification | [Cluster review index](controlled-verification/README.md); `INDEX-CONTROLLED-VERIFICATION-REVIEWS` / `REVIEW_INDEX` / revision `13`, LF `c9f24e6dabc46b0d63225e42291103697c52474f13edc1f2f83fcb4d213c4868` | `ACTIVE / CVQ01A_SPLIT_PROPOSED / OWNER_EXACT_APPROVAL_PENDING / CVQ01B_DEPENDENCY_AMENDMENT_PENDING / CVE01A_APPROVED_NOT_INTEGRATED` |
