...
| --- | --- | --- |
| Controlled verification | [Cluster review index](controlled-verification/README.md); `INDEX-CONTROLLED-VERIFICATION-REVIEWS` / `REVIEW_INDEX` / revision `26`, LF `d06c4675ed1ff5633f70db66808d15461b54c7345cc215893db69335e2abb77c` | `ACTIVE / CVQ01A1_REVIEW_APPROVED / CVQ01A2_CLOSURE02_CORRECTION_REQUIRED / CVQ01A3_B_DEPENDENCY_PENDING / CVE01A_APPROVED_NOT_INTEGRATED` |
...
| Plugin adoption quality | [Cluster review index](plugin-adoption-quality/README.md) | `WA-01_APPROVED / AUTHORITY_INTEGRATED; UIX-01_APPROVED / AUTHORITY_INTEGRATED; UIX-02_APPROVED / LOCAL_INTEGRATED / REMOTE_SYNC_PENDING; REQ-052_LOCAL_INSTALL_VERIFIED / PUBLICATION_INCOMPLETE / EXECUTABLE_GATES_PENDING` |
