...
| --- | --- | --- |
| Controlled verification | [Cluster review index](controlled-verification/README.md); `INDEX-CONTROLLED-VERIFICATION-REVIEWS` / `REVIEW_INDEX` / revision `25`, LF `5823cea8a0a5e8ccbf8b8d7a2293afad50255173e3d59fd6ea8d51a6df3050ac` | `ACTIVE / CVQ01A1_REVIEW_APPROVED / CVQ01A2_CLOSURE02_OWNER_APPROVED / CVQ01A3_B_DEPENDENCY_PENDING / CVE01A_APPROVED_NOT_INTEGRATED` |
