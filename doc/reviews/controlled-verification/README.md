...
Index identity: `INDEX-CONTROLLED-VERIFICATION-REVIEWS` / `REVIEW_INDEX` / revision `23`.
...
| `REVIEW-CONTROLLED-VERIFICATION-CVQ-01-CONVERGENCE` / [CVQ-01 convergence proposal](cvq-01-convergence-proposal.md) | `CODE_REVIEW` | `19` | `a21ccd9c68335e6b9a0e3deae249613ef2c5d9156794d3fdbbc04391a2af35c3` | `A1_REVIEW_APPROVED / A2_CONVERGENCE_REVIEW_REQUIRED` | `A3_B_DEPENDENCY_PENDING / BEHAVIOR_NOT_ADMITTED` |
