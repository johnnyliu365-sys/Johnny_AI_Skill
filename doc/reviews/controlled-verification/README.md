...
Index identity: `INDEX-CONTROLLED-VERIFICATION-REVIEWS` / `REVIEW_INDEX` / revision `14`.
...
| `REVIEW-CONTROLLED-VERIFICATION-CVQ-01-CONVERGENCE` / [CVQ-01 convergence proposal](cvq-01-convergence-proposal.md) | `CODE_REVIEW` | `10` | `c0bdc8df4b639ff7f7aefaac8ea1ebb7ea75a1bfc2163c16ac5fc05aab751cd0` | `EXACT_TICKET_PACKET_APPROVED` | `A1_IMPLEMENTATION_ADMITTED / A2_A3_B_DEPENDENCY_PENDING / BEHAVIOR_NOT_ADMITTED` |
