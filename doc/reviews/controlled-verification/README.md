...
Index identity: `INDEX-CONTROLLED-VERIFICATION-REVIEWS` / `REVIEW_INDEX` / revision `08`.
...
| `REVIEW-CONTROLLED-VERIFICATION-CVQ-01-CONVERGENCE` / [CVQ-01 convergence proposal](cvq-01-convergence-proposal.md) | `CODE_REVIEW` | `05` | `6ad63ea17bf1750549d1f5087138e9bb447b477bcd8d683cac7405bed1262847` | `SPLIT_REQUIRED / OWNER_REPLAN_DECISION_PENDING` | `NON_DISPATCHABLE / BEHAVIOR_NOT_ADMITTED` |
