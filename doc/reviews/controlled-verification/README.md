...
Index identity: `INDEX-CONTROLLED-VERIFICATION-REVIEWS` / `REVIEW_INDEX` / revision `29`.
...
| `REVIEW-CONTROLLED-VERIFICATION-CVQ-01-CONVERGENCE` / [CVQ-01 convergence proposal](cvq-01-convergence-proposal.md) | `CODE_REVIEW` | `24` | `02402fa14ea177c79be89c67f5b389e8e2709670b2262f7f1ff3be487d6fcdd3` | `A1_A2_REVIEW_APPROVED` | `A3_CONVERGENCE_REVIEW_REQUIRED / OWNER_DECISION_PENDING / B_DEPENDENCY_PENDING / NOT_INTEGRATED`
