...
Index identity: `INDEX-CONTROLLED-VERIFICATION-REVIEWS` / `REVIEW_INDEX` / revision `06`.
...
| `REVIEW-CONTROLLED-VERIFICATION-CVQ-01-SCHEMA` / [CVQ-01 schema preflight](cvq-01-schema-preflight.md) | `CODE_REVIEW` | `02` | `28d8dbd7f3836ac3088829385cf45a0e816e5e27014d28aa8fdbdde27b30eb06` | `CONVERGENCE_REVIEW_REQUIRED` | `CHANGES_REQUESTED / BEHAVIOR_NOT_ADMITTED` |
| `REVIEW-CONTROLLED-VERIFICATION-CVQ-01-CONVERGENCE` / [CVQ-01 convergence proposal](cvq-01-convergence-proposal.md) | `CODE_REVIEW` | `04` | `35d5f915c1bda24d34470b3608956aae42a3dede55f3a8ced876db7e4d1ec112` | `OWNER_DESIGN_ADOPTED / EXACT_CONTRACT_APPROVAL_PENDING` | `NON_DISPATCHABLE / BEHAVIOR_NOT_ADMITTED` |
