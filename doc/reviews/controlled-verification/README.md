...
Index identity: `INDEX-CONTROLLED-VERIFICATION-REVIEWS` / `REVIEW_INDEX` / revision `07`.
...
| `REVIEW-CONTROLLED-VERIFICATION-CVQ-01-SCHEMA` / [CVQ-01 schema preflight](cvq-01-schema-preflight.md) | `CODE_REVIEW` | `03` | `0b32f4315edd1123bf1f9fe2d561fa264b4ccf675262833f5876b8a893833460` | `SCHEMA_CORRECTION_REQUIRED` | `CHANGES_REQUESTED / BEHAVIOR_NOT_ADMITTED` |
