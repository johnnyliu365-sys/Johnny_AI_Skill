...
| `CTX-PARTITION-LOCAL-INSTALLER` | `PARTITION_INDEX` | `REVISION_02` | `3d5859ec9dd8d380043704b70a42d829f2683d7c83cfdf5479de9a7de3d67810` | `OWNER_SEMANTICS_CONFIRMED / CAPABILITY_RESEARCH_CONTEXT` | [`local-orchestration-installer/README.md`](local-orchestration-installer/README.md) |
