...
| `CTX-PARTITION-LOCAL-INSTALLER` | `PARTITION_INDEX` | `REVISION_01` | `fdf09a011681c84f9f30fec5c15609256a423b2102c2c71eb375044a2c7c5ee9` | `MSIX_DRAFT / OWNER_LIFECYCLE_DECISION_PENDING` | [`local-orchestration-installer/README.md`](local-orchestration-installer/README.md) |
