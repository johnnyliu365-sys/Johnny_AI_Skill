...
| `CTX-PARTITION-CONTROLLED-VERIFICATION` | `PARTITION_INDEX` | `REVISION_01` | `b9dd01b8ae7e9facd500850810337bc200875a51a40249bf0914984f537c4a8d` | `OWNER_DECISION_REQUIRED / NOT_SEALED` | [`controlled-verification/README.md`](controlled-verification/README.md) |
